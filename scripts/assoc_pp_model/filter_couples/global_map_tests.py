...
DEFAULT_INPUT = "Results/assoc_pp_model/All_datasets/Global_tests/noninferiority_reg_diffs.csv"
DEFAULT_OUTPUT = "Results/assoc_pp_model/All_datasets/Global_tests/uninformative_pairs_hypotest_visual.csv"
